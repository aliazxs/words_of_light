...
class CustomExpansionTile extends StatefulWidget {
  ...
  /// Whether the tile's border is displayed when the tile is expanded.
  /// Defaults to false.
  final bool hideBorder;

  /// Called when the user taps the tile.
  /// If null, pressing the content will expand/collapse the tile.
...
class _CustomExpansionTileState extends State<CustomExpansionTile>
      ...
      child: Column(
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            child: ListTile(
              onTap: widget.onContentTap ?? _handleArrowTap,
  ...
  void didChangeDependencies() {
    ...
    _headerColorTween
      ..begin = widget.collapsedTextColor ?? theme.textTheme.titleLarge!.color
