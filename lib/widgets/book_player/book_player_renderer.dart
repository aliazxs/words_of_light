...
import 'package:words_of_light/widgets/epub_renderer/epub_location.dart';
...
class BookPlayerRenderer extends StatefulWidget {
  ...
  @override
  BookRendererState createState() => BookRendererState();
}

class BookRendererState extends State<BookPlayerRenderer>
  ...
  List<EpubRendererContainer> epubRenderers = [];
  ...
  void initState() {
    ...
    for (int i = 0; i < renderers; i++) {
      epubRenderers.add(EpubRendererContainer(
        id: i,
