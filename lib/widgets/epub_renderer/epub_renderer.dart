...
import 'package:words_of_light/utils/enum_from_index.dart';
...
class EpubRenderer extends StatefulWidget {
  ...
  @override
  EpubRendererState createState() => EpubRendererState();
}

class EpubRendererState extends State<EpubRenderer> {
