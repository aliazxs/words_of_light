...
class Chapter {
  ...
  factory Chapter.fromEpubChapter(EpubChapter chapter, int depth) {
    return Chapter(
...
class BookPlayerNavigationView extends StatefulWidget {
  ...
  @override
  BookPlayerNavigationViewState createState() =>
      BookPlayerNavigationViewState();
}

class BookPlayerNavigationViewState extends State<BookPlayerNavigationView>
    with SingleTickerProviderStateMixin {
  late final List<Chapter> chapters;
  late final List<List<Chapter>> subChapters;
  ...
  void initState() {
    ...
    chapters =
        widget.chapters.map((e) => Chapter.fromEpubChapter(e, 0)).toList();
  ...
  List<Chapter> transformChapters(List<EpubChapter>? chapters, int depth) {
    ...
    for (final chapter in chapters) {
      result.add(Chapter.fromEpubChapter(chapter, depth));
...
class ChaptersView extends StatefulWidget {
  ...
  final List<List<Chapter>> subChapters;
  final TextStyle currentStyle;
  final EpubChapter? currentChapter;

  @override
  State<ChaptersView> createState() => ChaptersViewState();
}

class ChaptersViewState extends State<ChaptersView>
    with AutomaticKeepAliveClientMixin {
