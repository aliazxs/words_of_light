...
import 'package:words_of_light/pages/home_settings.dart';
import 'package:words_of_light/providers/book_downloader/book_downloader.dart';
import 'package:words_of_light/widgets/language_manager.dart';
      ...
      FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            return const Center(child: Text('There is no books.'));
          }
        },
      ),
      Search(
